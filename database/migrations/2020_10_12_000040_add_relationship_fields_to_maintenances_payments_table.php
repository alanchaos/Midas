...
class AddRelationshipFieldsToMaintenancesPaymentsTable extends Migration
{
    public function up()
    {
        Schema::table('maintenances_payments', function (Blueprint $table) {
            ...
            $table->foreign('username_id', 'username_fk_2310738')->references('id')->on('users');
            $table->unsignedInteger('payment_method_id');
            $table->foreign('payment_method_id', 'payment_method_fk_2310753')->references('id')->on('payment_methods');
        });
    }
}
