                        ...
                        <tr data-entry-id="{{ $maintenancesPayment->id }}">
                            ...
                            <td>
                                @can('maintenances_payment_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.maintenances-payments.show', $maintenancesPayment->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('maintenances_payment_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.maintenances-payments.edit', $maintenancesPayment->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('maintenances_payment_delete')
                                    <form action="{{ route('admin.maintenances-payments.destroy', $maintenancesPayment->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
