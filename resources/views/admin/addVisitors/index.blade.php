                        ...
                        <tr data-entry-id="{{ $addVisitor->id }}">
                            ...
                            <td>
                                @can('add_visitor_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.add-visitors.show', $addVisitor->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('add_visitor_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.add-visitors.edit', $addVisitor->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('add_visitor_delete')
                                    <form action="{{ route('admin.add-visitors.destroy', $addVisitor->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
